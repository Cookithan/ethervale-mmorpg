...
Ce jeu utilise des assets de plusieurs créateurs. Merci à eux !

## Ninja Adventure Asset Pack
- **Auteur :** Pixel-boy & AAA
- **Licence :** CC0 (domaine public — usage libre, y compris commercial)
- Base du jeu : personnages, monstres/boss, props, UI, FX, audio.

## Sprout Lands — Basic Pack
- **Auteur :** Cup Nooble — https://cupnooble.itch.io/sprout-lands-asset-pack
- **Licence :** gratuite, **usage non-commercial uniquement**, crédit requis.
- Utilisé pour : sols (herbe), eau animée, relief/collines, déco et bâtiments de village.
- *Assets — From: Sprout Lands — By: Cup Nooble.*

## Mystic Woods (Free Version)
- **Auteur :** Game Endeavor — https://game-endeavor.itch.io/mystic-woods
...
appropriée. Les packs bruts ne sont pas redistribués dans ce dépôt (seuls les sprites utilisés sont
inclus dans `public/assets/`).
