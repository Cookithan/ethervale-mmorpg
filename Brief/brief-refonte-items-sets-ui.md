...
- 🟡 **5. Sorts (Mage fait, Soigneur À FAIRE)** : **Mage `625621b`** — PV 60, sort 1 Météore→**Blizzard** (givre+ralentit, FX `Elemental/Ice` + `Magic/Circle`, `Monster.applySlow`), sort 2 mirror→**Pyroblast** (mono-cible feu), tous incantés. **Soigneur PAS ENCORE** : sort 1 Soin→Bouclier+petit soin, +dégâts d'attaque de base.
...
- ⏭️ Reste : **5b Soigneur** (Bouclier+soin / +dégâts), 8 (drops+pity boss → retirer le debug G), 9 (barre de compétences — afficher le sort 3 de set), 10 (onglet perso).
