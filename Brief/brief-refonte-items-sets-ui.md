...
- 🟡 **7. Compétences de set (amorce)** : **touche 3 = `castSpell3`** (dispo si `p.activeSet`, cooldown ~35 s, coût 30). **Image miroir (mage) branchée et OK** ; warcry/shockwave/resurrect → « Bientôt » (à coder).
- ⏭️ Reste : 5 (sorts Mage/Soigneur), 7 (3 compétences de set restantes), 8 (drops+pity boss), 9 (barre de compétences — afficher correctement le sort 3 de set), 10 (onglet perso).
