...
- ⏭️ Reste : **8** (drops+pity boss → obtenir les sets légitimement, retirer le debug G), **9** (barre de compétences WoW — afficher le sort 3 de set), **10** (onglet perso paper-doll).
