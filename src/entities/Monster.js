...
export const MONSTER_TYPES = {
  mushroom: { key: 'mon_mushroom', hp: 90, speed: 22, damage: 12, xp: 25, aggro: 70, name: 'Champignon' },
  lizard: { key: 'mon_lizard', hp: 30, speed: 72, damage: 5, xp: 10, aggro: 130, name: 'Lézard' },
  racoon: { key: 'mon_racoon', hp: 55, speed: 46, damage: 8, xp: 15, aggro: 105, name: 'Raton' },
}
...
export default class Monster extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, x, y, typeKey) {
    ...
    this.body.setSize(12, 10).setOffset(2, 5)
    this.facing = 'down'
    ...
    this.hpBarBg = scene.add.rectangle(x, y - 12, 16, 3, 0x000000, 0.6).setDepth(50000).setVisible(false)
    this.hpBarFg = scene.add.rectangle(x, y - 12, 14, 1, 0xff4444).setOrigin(0, 0.5).setDepth(50001).setVisible(false)
    this.hpHideAt = 0
  }
  ...
  updateHpBar(time) {
    ...
    this.hpBarFg.setPosition(this.x - 7, this.y - 12)
